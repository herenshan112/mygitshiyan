...
class pagesin{
    ...
    private function first(){
        ...
        if($this->page==1){
            ...
            @$html.='<a href="?page=1'.$this->caijieary($this->arycont).'" >首页</a>';
        }
        return $html;
    }
    //上一页
    private function prev(){
        ...
        if($this->page==1){
            ...
            @$html.='<a  href="?page='.($this->page-1).$this->caijieary($this->arycont).'" >上一页</a>';
        }
        return $html;
    }
    //下一页
    private function next(){
        ...
        if($this->page == $this->pagenum){
            ...
            @$html.='<a  href="?page='.($this->page+1).$this->caijieary($this->arycont).'">下一页</a>';
        }
        return $html;
    }
    //尾页
    private function last(){
        ...
        if($this->page==$this->pagenum){
            ...
            @$html.='<a  href="?page='.($this->pagenum).$this->caijieary($this->arycont).'">尾页</a>';
        }
        return $html;
    }
    //当前页
